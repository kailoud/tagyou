-- Festival Information Tables for TagYou Integration
-- This file contains SQL schemas for festival-related data (Food Stalls, Float Trucks, Artists)
...
-- Sample Food Stalls Data (for Notting Hill Carnival)
